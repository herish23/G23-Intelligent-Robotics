"""
Likelihood field for range sensor models
Used by Markov and AMCL for efficient sensor updates
"""
...
def compute_likelihood_field(map_info, sigma=0.1, max_dist=2.0):
    """
    Pre-compute likelihood field for sensor model
    Higher values near obstacles
    """
    ...
    # Gaussian likelihood around obstacles
...
def compute_beam_model_likelihood(scan_range, expected_range, sigma_hit=0.1,
    ...
    """
    Beam sensor model with mixture of hit/short/max/random
    More sophisticated than likelihood field
    """
    # Hit (Gaussian)
...
def ray_cast(x, y, theta, angle, map_info, max_range=3.5):
    """Simple ray tracing to find expected range"""
...
def compute_scan_likelihood_field(scan_ranges, scan_angles, robot_x, robot_y,
    ...
    """
    Compute log-likelihood of scan using pre-computed field
